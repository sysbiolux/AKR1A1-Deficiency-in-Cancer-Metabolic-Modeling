...
parfor i = 1:maxWorkers
    ...
    samplingResults_mediumonoff = struct();
    ...
    samplingResults_mediumonoff(i).modelSampling = modelSampling;

    parsave_custom(strcat("samplingResults_mediumonoff_", num2str(options.nPointsReturned) , "_model_", num2str(i),  ".mat"), samplingResults_mediumonoff(i));
end

...
srun -c ${SLURM_CPUS_PER_TASK} matlab -nodisplay -nosplash < ${HOME}/sampling_test_jeff/sampling_test_mediumonoff.m > ${SCRATCH}/output_job_${SLURM_JOB_ID}.out

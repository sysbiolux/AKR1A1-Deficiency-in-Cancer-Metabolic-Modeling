...
for i=1:numel(models_7_RPMIbiomass)
   ...
   grRateWT_ATP=ones(numel(grRatio_ATP),1)*grRateWT_ATP;
    ...
    name2= strcat('medium_essential', modelNames_7(i));
...
for i=1:numel(modelNames_H)
   ...
   grRateWT_ATP=ones(numel(grRatio_ATP),1)*grRateWT_ATP;
    ...
    name2= strcat('medium_essential', modelNames_H(i));
    save (name2{1},'TEssential');

end
save  769-PHuh7TEssential

%% Single Gene Deletion Analysis
geneList_keep=struct();
%% run the single gene deletion for 769-P for GLO1KO
...
%% run the single gene deletion for Huh7 for GLO1KO
for i=1:numel(modelNames_H)
    name =  modelNames_H(i);
    model = models_H_DMEMbiomass{i}; %for each model
    model = changeObjective(model,'DM_atp_c_');
...
minFlux_7_keep(ismember(consistent_model.rxns,model_7_sc12.rxns),4)=minFlux_7sc12;
maxFlux_7_keep(ismember(consistent_model.rxns,model_7_sc12.rxns),4)=maxFlux_7sc12;
...
minFlux_H_keep(ismember(consistent_model.rxns,model_H_sc12.rxns),4)=minFlux_Hsc12;
maxFlux_H_keep(ismember(consistent_model.rxns,model_H_sc12.rxns),4)=maxFlux_Hsc12;
...
modelNames_7_decrease = {'model_769-P_sc1', 'model_769-P_sc2', 'model_769-P_sc12'}; 
modelNames_H_decrease = {'model_Huh7_sc1', 'model_Huh7_sc2', 'model_Huh7_sc12'};

modelNames_7_decrease2 = {'model_7_sc1', 'model_7_sc2', 'model_7_sc12'}; 
modelNames_H_decrease2 = {'model_H_sc1', 'model_H_sc2', 'model_H_sc12'};

...
inputDir = fullfile('results','analysis','FVA','visualization_inputs');
outputDir = fullfile('results','analysis','FVA','figures');
...
disp('Cell-line FVA heatmaps finished');
...
function make_cellline_heatmaps( ...
    files, labels, outputNames, numPathways, outputDir)
